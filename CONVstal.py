...
for i in [3, 4, 6, 7, 8, 10, 11, 12, 14, 15]:
    if i == 3:
        DAY0 = StalnaiaExcel.PRICE1
        DAY1 = StalnaiaExcel.CH_DAY1
        DAY2= StalnaiaExcel.CH_DAY_PR1
        WEEK1 = StalnaiaExcel.CH_W1
        WEEK2= StalnaiaExcel.CH_W_PR1
        MONTH1 = StalnaiaExcel.CH_M1
        MONTH2 = StalnaiaExcel.CH_M_PR1
    elif i == 4:
        DAY0 = StalnaiaExcel.PRICE2
        DAY1 = StalnaiaExcel.CH_DAY2
        DAY2= StalnaiaExcel.CH_DAY_PR2
        WEEK1 = StalnaiaExcel.CH_W2
        WEEK2= StalnaiaExcel.CH_W_PR2
        MONTH1 = StalnaiaExcel.CH_M2
        MONTH2 = StalnaiaExcel.CH_M_PR2
    elif i == 6:
        DAY0 = StalnaiaExcel.PRICE3
        DAY1 = StalnaiaExcel.CH_DAY3
        DAY2= StalnaiaExcel.CH_DAY_PR3
        WEEK1 = StalnaiaExcel.CH_W3
        WEEK2= StalnaiaExcel.CH_W_PR3
        MONTH1 = StalnaiaExcel.CH_M3
        MONTH2 = StalnaiaExcel.CH_M_PR3
    elif i == 7:
        DAY0 = StalnaiaExcel.PRICE4
        DAY1 = StalnaiaExcel.CH_DAY4
        DAY2= StalnaiaExcel.CH_DAY_PR4
        WEEK1 = StalnaiaExcel.CH_W4
        WEEK2= StalnaiaExcel.CH_W_PR4
        MONTH1 = StalnaiaExcel.CH_M4
        MONTH2 = StalnaiaExcel.CH_M_PR4
    elif i == 8:
        ...
        DAY0 = StalnaiaExcel.PRICE6
        DAY1 = StalnaiaExcel.CH_DAY6
        DAY2= StalnaiaExcel.CH_DAY_PR6
        WEEK1 = StalnaiaExcel.CH_W6
        WEEK2= StalnaiaExcel.CH_W_PR6
        MONTH1 = StalnaiaExcel.CH_M6
        MONTH2 = StalnaiaExcel.CH_M_PR6
    elif i == 11:
        DAY0 = StalnaiaExcel.PRICE7
        DAY1 = StalnaiaExcel.CH_DAY7
        DAY2= StalnaiaExcel.CH_DAY_PR7
        WEEK1 = StalnaiaExcel.CH_W7
        WEEK2= StalnaiaExcel.CH_W_PR7
        MONTH1 = StalnaiaExcel.CH_M7
        MONTH2 = StalnaiaExcel.CH_M_PR7
    elif i == 12:
        ...
        DAY0 = StalnaiaExcel.PRICE9
        DAY1 = StalnaiaExcel.CH_DAY9
        DAY2= StalnaiaExcel.CH_DAY_PR9
        WEEK1 = StalnaiaExcel.CH_W9
        WEEK2= StalnaiaExcel.CH_W_PR9
        MONTH1 = StalnaiaExcel.CH_M9
        MONTH2 = StalnaiaExcel.CH_M_PR9
    elif i == 15:
