...
for i in [3, 4, 6, 7, 8, 10, 11, 12, 14, 15]:
    if i == 3:
        DAY0 = GetStal.PRICE1
        DAY1 = GetStal.CH_DAY1
        DAY2= GetStal.CH_DAY_PR1
        WEEK1 = GetStal.CH_W1
        WEEK2= GetStal.CH_W_PR1
        MONTH1 = GetStal.CH_M1
        MONTH2 = GetStal.CH_M_PR1
    elif i == 4:
        DAY0 = GetStal.PRICE2
        DAY1 = GetStal.CH_DAY2
        DAY2= GetStal.CH_DAY_PR2
        WEEK1 = GetStal.CH_W2
        WEEK2= GetStal.CH_W_PR2
        MONTH1 = GetStal.CH_M2
        MONTH2 = GetStal.CH_M_PR2
    elif i == 6:
        DAY0 = GetStal.PRICE3
        DAY1 = GetStal.CH_DAY3
        DAY2= GetStal.CH_DAY_PR3
        WEEK1 = GetStal.CH_W3
        WEEK2= GetStal.CH_W_PR3
        MONTH1 = GetStal.CH_M3
        MONTH2 = GetStal.CH_M_PR3
    elif i == 7:
        DAY0 = GetStal.PRICE4
        DAY1 = GetStal.CH_DAY4
        DAY2= GetStal.CH_DAY_PR4
        WEEK1 = GetStal.CH_W4
        WEEK2= GetStal.CH_W_PR4
        MONTH1 = GetStal.CH_M4
        MONTH2 = GetStal.CH_M_PR4
    elif i == 8:
        DAY0 = GetStal.PRICE5
        DAY1 = GetStal.CH_DAY5
        DAY2= GetStal.CH_DAY_PR5
        WEEK1 = GetStal.CH_W5
        WEEK2= GetStal.CH_W_PR5
        MONTH1 = GetStal.CH_M5
        MONTH2 = GetStal.CH_M_PR5
    elif i == 10:
        DAY0 = GetStal.PRICE6
        DAY1 = GetStal.CH_DAY6
        DAY2= GetStal.CH_DAY_PR6
        WEEK1 = GetStal.CH_W6
        WEEK2= GetStal.CH_W_PR6
        MONTH1 = GetStal.CH_M6
        MONTH2 = GetStal.CH_M_PR6
    elif i == 11:
        DAY0 = GetStal.PRICE7
        DAY1 = GetStal.CH_DAY7
        DAY2= GetStal.CH_DAY_PR7
        WEEK1 = GetStal.CH_W7
        WEEK2= GetStal.CH_W_PR7
        MONTH1 = GetStal.CH_M7
        MONTH2 = GetStal.CH_M_PR7
    elif i == 12:
        DAY0 = GetStal.PRICE8
        DAY1 = GetStal.CH_DAY8
        DAY2= GetStal.CH_DAY_PR8
        WEEK1 = GetStal.CH_W8
        WEEK2= GetStal.CH_W_PR8
        MONTH1 = GetStal.CH_M8
        MONTH2 = GetStal.CH_M_PR8
    elif i == 14:
        DAY0 = GetStal.PRICE9
        DAY1 = GetStal.CH_DAY9
        DAY2= GetStal.CH_DAY_PR9
        WEEK1 = GetStal.CH_W9
        WEEK2= GetStal.CH_W_PR9
        MONTH1 = GetStal.CH_M9
        MONTH2 = GetStal.CH_M_PR9
    elif i == 15:
        DAY0 = GetStal.PRICE10
        DAY1 = GetStal.CH_DAY10
        DAY2= GetStal.CH_DAY_PR10
        WEEK1 = GetStal.CH_W10
        WEEK2= GetStal.CH_W_PR10
        MONTH1 = GetStal.CH_M10
        MONTH2 = GetStal.CH_M_PR10
    else:
        print("ERROR")
    DDD0 = str (DAY0)
    DDD1 = f"{DAY1:+}"
