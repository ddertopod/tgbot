...
MYDATA5 = [["-", cellRu, str(PRICE5) + " CNY/т", f"{CH_DAY5:+}"+ " CNY/т", f"{CH_DAY_PR5:+}" + " %", f"{CH_W5:+}"+ " CNY/т", f"{CH_W_PR5:+}" + " %", f"{CH_M5:+}"+ " CNY/т", f"{CH_M_PR5:+}" + " %"]]
...
MYDATA8 = [["-", cellFob, str(PRICE8) + " USD/т", f"{CH_DAY8:+}"+ " USD/т", f"{CH_DAY_PR8:+}" + " %", f"{CH_W8:+}"+ " USD/т", f"{CH_W_PR8:+}" + " %", f"{CH_M8:+}"+ " USD/т", f"{CH_M_PR8:+}" + " %"]]
MYDATA9 = [["-", cellFR, str(PRICE9) + " USD/т", f"{CH_DAY9:+}"+ " USD/т", f"{CH_DAY_PR9:+}" + " %", f"{CH_W9:+}"+ " USD/т", f"{CH_W_PR9:+}" + " %", f"{CH_M9:+}"+ " USD/т", f"{CH_M_PR9:+}" + " %"]]
MYDATA10 = [["-", cellFAC, str(PRICE10) + " USD/1% Mn в смт", f"{CH_DAY10:+}"+ " USD/1% Mn в смт", f"{CH_DAY_PR10:+}" + " %", f"{CH_W10:+}"+ " USD/1% Mn в смт", f"{CH_W_PR10:+}" + " %", f"{CH_M10:+}"+ " USD/1% Mn в смт", f"{CH_M_PR10:+}" + " %"]]
MYFILE1 = open('slovarFerro1.csv', 'w', encoding = 'utf-8' )
with MYFILE1:
